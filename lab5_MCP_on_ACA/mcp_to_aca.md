## Building and Publishing a Remote MCP Server to ACA

![MCP to ACA](./images/mcp_to_aca.png)

### Lab Overview
In this lab, you will build and publish a Model Context Protocol (MCP) server to the Azure Container Apps (ACA) environment. This will enable you to build and scale AI applications using MCP servers hosted on ACA.
